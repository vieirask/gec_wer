...
#########################
python path to leven_per_src.py processed/train.src processed/train.trg processed/train.leven.src processed/train.leven.trg

#########################
# preprocessing
python $FAIRSEQPY/preprocess.py --source-lang src --target-lang trg --trainpref processed/train.leven --validpref processed/dev --testpref  processed/dev --nwordssrc 30000 --nwordstgt 30000 --destdir processed/bin
